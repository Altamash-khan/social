...
public class FriendTest {
 ...
 @Ignore
   ...
   {
	   List<Friend> listFriends=friendDAO.showFriendList("Aditiya");
  ...
  {
	  List<Friend> listFriends=friendDAO.showPendingFriendRequest("Aditiya");
	  assertTrue("Problem in getting the Friend List:",listFriends.size()>0);
	  for(Friend friend:listFriends)
	   {
		   System.out.println(friend.getLoginname());
...
{
	List<UserDetail> friendList=friendDAO.showSuggestedFriend("Aditiya");
